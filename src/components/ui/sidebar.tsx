...
import { useIsMobile } from "../../components/ui/ShadCnSideBarComps/use_Mobile"
import { cn } from "../../components/ui/ShadCnSideBarComps/utils"
import { Button } from "@/components/ui/button"
import { Input, type CustomInputProps } from "@/components/ui/input"
      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper fixed top-0 left-0 bottom-0 flex min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar",
              className
            )}
            ref={ref}
            {...props}
