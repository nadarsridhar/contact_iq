...
export const desktopColumns: ColumnDef<CallTrafficReportSchema>[] = [
  {
    accessorKey: "UserId",
    header: ({ column }) => (
  ...
  {
    accessorKey: "DistinctClient",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Unique Clients" />
    ),
    enableResizing: true,
    size: 90,
    minSize: 30,
  ...
  {
    accessorKey: "AverageCallDuration",
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Average Duration" />
    ),
    enableResizing: true,
    size: 90,
    minSize: 30,
...
export const mobileColumns: ColumnDef<CallTrafficReportSchema>[] = [
  {
